        ...
        <div className="bg-primary text-white md:p-8 p-4 rounded-[.75rem] md:rounded-[1.5rem]">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 pt-4 md:pb-10 pb-8">
            ...
            <div>
              ...
              <a
                href="/"
                className="uppercase flex flex-col text-xs text-white tracking-wider mb-8 gap-[4px]"
              >
              ...
              <p className="text-gray-400 text-xs leading-relaxed">
                Удаленная команда для вашего проекта. Проектирование, разработка и поддержка проектов любой сложности.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3 text-gray-400 text-xs">
                <li className="flex items-center gap-2">
                  ...
                  <a href={`tel:${siteConfig.contacts.phoneRaw}`} className="hover:text-white transition-colors">
